...
Aplicação CarePulse desenvolvida com TypeScript para estudo de fluxos de agendamento, saúde digital e interfaces modernas.
...
- Estudo de fluxos de agendamento em saude digital.
- Interface para experiencia de pacientes e marcacao de consultas.
- Organizacao de telas e dados para aplicacao moderna.
- Projeto TypeScript para pratica full-stack.
...
- Aplicacao Next.js inspirada em produto de saude digital.
- Foco em formularios, fluxos e interface responsiva.
- Projeto de estudo com stack moderna.
